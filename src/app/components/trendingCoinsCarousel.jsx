...
const TrendingCoinsCarousel = () => {
    ...
    return (
        <div className=' md:pt-10'>
                <h1 className='text-xl md:text-2xl font-semibold leading-[30px]'>Trending Coins</h1>
                <div className='flex w-full justify-between pt-4 md:pt-10'>
                    ...
                    <div className='flex w-[90%] md:w-[96%] justify-start '>
                        {
                            loading ?
                                <Loading /> :
                                <main className='flex w-full space-x-3 overflow-hidden' ref={carouslRef}>
                                    {trendingCoins.slice(3, 8).map((coin, i) => (
